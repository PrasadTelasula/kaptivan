module github.com/prasad/kaptivan/backend
...
require (
	...
	golang.stackrox.io/kube-linter v0.0.0-00010101000000-000000000000
	k8s.io/api v0.33.4
...
require (
	...
	github.com/kedacore/keda/v2 v2.17.2 // indirect
...
replace golang.stackrox.io/kube-linter => ./internal/linter/kube-linter
